...
def get_csv_location(which):
    ...
    server = Path('/Users/Serkan/Desktop/academia/PhD/rotations/cortex_lab/data')
...
def get_server_list():
    ...
    # ]
    server_list = [Path('/Users/Serkan/Desktop/academia/PhD/rotations/cortex_lab/project/pinkrigs_tools/data/Subjects')]
    ...
    if data_name_dict:
        ...
        for collection in collections:
            ...
            for idx, rec in recordings.iterrows():
                ...
                date = rec.expFolder[-12:-2]
                animal = rec.expFolder[-18:-13]
                # exp_folder_str = f'/Users/Serkan/Desktop/academia/PhD/rotations/cortex_lab/project/pinkrigs_tools/data/Subjects/{animal}/{date}/1'
                exp_folder_str = f'/Users/Serkan/Desktop/academia/PhD/rotations/cortex_lab/data/Subjects/{animal}/{date}/1'
                ...
                if 'raw' in collection and 'probe' in collection:
                    ...
                    coll = collection + '/'
                    ev_collection_folder = exp_folder / 'ONE_preproc' / coll
                objects = {}
